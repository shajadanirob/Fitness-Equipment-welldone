...
const WeightPlates: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://assignment-foure-server.vercel.app/api/products?categories=WeightPlates');
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      <h1 className="text-3xl font-bold mb-4 text-center">Products for Category: WeightPlates</h1>
